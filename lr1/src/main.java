...
                "call <number>\t\tcall to number 
                 (only if balance more then 0.5)\n" +
                "endCall\t\t\t\tend talking\n" +
...
                                "May be you entered a negative amount or 
           				   a zero?\n");
                    }
                    break;
...
                        System.out.println("Your phone conversation lasted: " 
+ elapsed + " seconds");
                        if (didYouCall)
